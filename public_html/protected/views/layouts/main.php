...
<div id="content">
    <div class="header">
        <div class="container">
            <div class="header-wrap">
                <div class="logo">
                    <a href="/">
                        <img src="/img/logo.png" alt="Магазин фейерверков piro.by">
                    </a>
                </div>
                <ul class="numbers">
    ...
    <div class="wrapper">
        <div class="main inner">
            ...
            <?=$content;?>
            <div id="miniForm"  style="margin: 5px 0px 10px 0px;display: flex;justify-content: center">
                <? if ($promoCode = FrontendItem::getCurrentPromocode()):?>
                    <strong>Промокод <?=$promoCode?> активен</strong>
                <?else:?>
                    <form action="" method='post' id='promocode-formMini'>
                        ...
                        <input onclick="promoCodeFormSubmit(event)" type="submit" value="Применить">
                    </form>
                <?endif?>
            </div>
            <div class="sidebar sidebar-fix">
                ...
                <div>
                    <ul class="sidebar-menu sidebar-fix-menu">
                        ...
                        <h1 class="catal d-none">Каталог товаров: </h1>
                        <?foreach($this->cats as $cat):?>
                    ...
                    <div id="largeForm" style="margin-top: 15px;">
                        <? if ($promoCode = FrontendItem::getCurrentPromocode()):?>
                            <strong>Промокод <?=$promoCode?> активен</strong>
                        <?else:?>
        ...
        <div class="dm-table">
            <div class="dm-cell">
                <div class="dm-modal">
                    ...
                    <div class="butto">
                        <a href="#" class="button button-gray" onclick="closeVideo(event,this)"><i class="fa fa-times"></i>Закрыть</a>
